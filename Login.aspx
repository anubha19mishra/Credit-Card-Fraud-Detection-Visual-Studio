        ...
        <div class="menu-logo">
            <div class="navbar-brand">
                <span class="navbar-logo">
                    <a href= "Default.aspx">
                        &nbsp;<img src="icon.jpg" alt="SHop" title="" style="height: 3.8rem;"></a></span></div>
        </div>
                ...
                <form id="form1" runat="server">
                    ...
                    <div class="dragArea row row-sm-offset">
                        <div class="col-md-4  form-group" data-for="email">
                            <label for="email-form1-e" class="auto-style1">Email</label>
                            <br />
&nbsp;<asp:TextBox ID="TextBox1" runat="server" OnTextChanged="TextBox1_TextChanged"></asp:TextBox>
                            <br />
                        </div>
                        <div data-for="phone" class="col-md-4  form-group">
                            <label for="phone-form1-e" class="auto-style1">Password&nbsp;&nbsp;&nbsp;&nbsp; </label>&nbsp;
                            <br />
                            <asp:TextBox ID="TextBox2" runat="server"></asp:TextBox>
                            <br />
                        </div>
                        
                        <div class="col-md-12 input-group-btn align-center">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:Label ID="Label1" runat="server"></asp:Label>
